...
pub static OPCODES: &'static [OpcodeFunction] = &[
    Cpu::nop, Cpu::ld_bc_nn, Cpu::ld_bc_a, Cpu::inc_combined_bc, Cpu::nyi, Cpu::nyi, Cpu::ld_b_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::ld_a_bc, Cpu::dec_combined_bc, Cpu::nyi, Cpu::nyi, Cpu::ld_c_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_de_nn, Cpu::ld_de_a, Cpu::inc_combined_de, Cpu::nyi, Cpu::nyi, Cpu::ld_d_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::ld_a_de, Cpu::dec_combined_de, Cpu::nyi, Cpu::nyi, Cpu::ld_e_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_hl_nn, Cpu::nyi, Cpu::inc_combined_hl, Cpu::nyi, Cpu::nyi, Cpu::ld_h_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::dec_combined_hl, Cpu::nyi, Cpu::nyi, Cpu::ld_l_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_sp_nn, Cpu::nyi, Cpu::inc_combined_sp, Cpu::nyi, Cpu::nyi, Cpu::ld_hl_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::dec_combined_sp, Cpu::nyi, Cpu::nyi, Cpu::ld_a_n, Cpu::nyi,
    ...
    Cpu::add_a_b, Cpu::add_a_c, Cpu::add_a_d, Cpu::add_a_e, Cpu::add_a_h, Cpu::add_a_l, Cpu::nyi, Cpu::add_a_a, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi,
