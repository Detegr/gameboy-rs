...
pub static OPCODES: &'static [OpcodeFunction] = &[
    Cpu::nop, Cpu::ld_bc_nn, Cpu::ld_bc_a, Cpu::inc_combined_bc, Cpu::inc_b, Cpu::dec_b, Cpu::ld_b_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::ld_a_bc, Cpu::dec_combined_bc, Cpu::inc_c, Cpu::dec_c, Cpu::ld_c_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_de_nn, Cpu::ld_de_a, Cpu::inc_combined_de, Cpu::inc_d, Cpu::dec_d, Cpu::ld_d_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::ld_a_de, Cpu::dec_combined_de, Cpu::inc_e, Cpu::dec_e, Cpu::ld_e_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_hl_nn, Cpu::nyi, Cpu::inc_combined_hl, Cpu::inc_h, Cpu::dec_h, Cpu::ld_h_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::dec_combined_hl, Cpu::inc_l, Cpu::dec_l, Cpu::ld_l_n, Cpu::nyi,
    Cpu::nyi, Cpu::ld_sp_nn, Cpu::nyi, Cpu::inc_combined_sp, Cpu::inc_hl, Cpu::dec_hl, Cpu::ld_hl_n, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::nyi, Cpu::dec_combined_sp, Cpu::inc_a, Cpu::dec_a, Cpu::ld_a_n, Cpu::nyi,
